...
class Alarm:
    def trigger(self):  # 触发报警
        pass

# 抽象类：AbstractAlarm，实现了报警器接口


class AbstractAlarm(Alarm):
    def trigger(self):
        # 空方法体，具体报警器实现时需覆盖该方法
        pass
...
class SecurityDoor(AbstractAlarm, Door):
    def open(self):
        print("安全门打开")
