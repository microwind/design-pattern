...
public class MemberUser extends AbstractUser {
   ...
   public void send(String message) {
      System.out.println("MemberUser:send() [user: " + this.getName() + " send message:" + message + "]");
      // 通过中介者来中转消息
   ...
   public void sendTo(String to, String message) {
      System.out
            .println("MemberUser:sendTo() [user: " + this.getName() + " send message:" + message + " to: " + to + "]");
      // 通过中介者来中转消息
   ...
   public void recieve(String from, String message) {
      System.out.println("MemberUser:recieve() [user: " + this.getName() + " recieve message: " + message
            + " from user:" + from + "]");
   }
